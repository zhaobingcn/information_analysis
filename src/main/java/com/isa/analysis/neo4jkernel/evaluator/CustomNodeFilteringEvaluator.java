package com.isa.analysis.neo4jkernel.evaluator;
...
public class CustomNodeFilteringEvaluator implements Evaluator{
    ...
    public Evaluation evaluate(Path path) {
        ...
        if(!currentNode.hasLabel(Labels.Institution)){
            return Evaluation.EXCLUDE_AND_CONTINUE;
        }
        //遍历指向当前节点的HAS_SEEN关系
        for(Relationship r : currentNode.getRelationships(Direction.INCOMING, RelationshipTypes.publish)){
